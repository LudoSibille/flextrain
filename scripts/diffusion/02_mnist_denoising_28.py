...
from flextrain.diffusion.discrete_beta_schedulers import sigmoid_beta_schedule
...
if __name__ == '__main__':
    ...
    model = DiffusionModelUNetConditioned(model, image_conditioning_name='images_noisy')
    ...
    ddpm_pl = GaussianDiffusionLightning(
        ddpm,
        input_name='images',
        input_conditioning_names='images_noisy',
    )
