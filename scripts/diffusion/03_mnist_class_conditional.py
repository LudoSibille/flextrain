...
from utils import TransformLambda, batch_images_adapator_0_1
...
if __name__ == '__main__':
    ...
    transform_train = transforms.Compose(
        [
            ...
            TransformLambda(
                lambda t: torch.asarray(t, dtype=torch.float32).unsqueeze(0),
                input_names=['targets'],
    ...
    model = DiffusionModelUNet(
        ...
        cross_attention_dim=1,  # the class embeddings
    ...
    ddpm_pl = GaussianDiffusionLightning(
        ddpm,
        input_name='images',
        input_conditioning_names='context',
    )
