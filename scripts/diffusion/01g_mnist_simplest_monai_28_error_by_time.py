"""
Investigate the diffusion step errors relative to time steps. Would it be useful
to adapt the time steps distribution to where the largest errors are made?
"""
...
from flextrain.callbacks.diffusion_error_by_time import CallbackDiffusionErrorByTime
